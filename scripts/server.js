...
server.use((req, res, next) => {
    res.setHeader(
        ...
        "default-src 'self' http://ugdev.cs.smu.ca:3701"
    );
    next();
});
 ...
 *
 * Author: Terry Goldsmith (author of original)
 *         Travis burke (Revised by)
 */
 ...
 */
server.listen(port, () => {
    console.log("Server is running on ugdev.cs.smu.ca:3701");
    console.log("Listening on port 3701");
});
